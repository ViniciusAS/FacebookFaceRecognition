...
${OBJECTDIR}/_ext/270dbb15/FaceRecognition.o: /home/viniciusas/Programacao/FaceRecognition/FaceRecognition.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags opencv` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/270dbb15/FaceRecognition.o /home/viniciusas/Programacao/FaceRecognition/FaceRecognition.cpp
