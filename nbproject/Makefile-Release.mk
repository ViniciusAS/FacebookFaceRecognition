...
${OBJECTDIR}/_ext/270dbb15/FaceRecognitionQueue.o: /home/viniciusas/Programacao/FaceRecognition/FaceRecognitionQueue.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags opencv` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/270dbb15/FaceRecognitionQueue.o /home/viniciusas/Programacao/FaceRecognition/FaceRecognitionQueue.cpp

${OBJECTDIR}/_ext/270dbb15/FaceRecognizer.o: /home/viniciusas/Programacao/FaceRecognition/FaceRecognizer.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/270dbb15
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags opencv` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/270dbb15/FaceRecognizer.o /home/viniciusas/Programacao/FaceRecognition/FaceRecognizer.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags opencv` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
